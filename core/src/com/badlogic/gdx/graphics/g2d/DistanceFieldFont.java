...
public class DistanceFieldFont extends BitmapFont
{
    ...
    public DistanceFieldFont(final BitmapFontData data, final Array<TextureRegion> pageRegions, final boolean integer) {
        super(data, pageRegions, integer);
    }
    
    public DistanceFieldFont(final BitmapFontData data, final TextureRegion region, final boolean integer) {
        super(data, region, integer);
    }
    
    public DistanceFieldFont(final FileHandle fontFile, final boolean flip) {
        super(fontFile, flip);
    }
    
    public DistanceFieldFont(final FileHandle fontFile, final FileHandle imageFile, final boolean flip, final boolean integer) {
        super(fontFile, imageFile, flip, integer);
    }
    
    public DistanceFieldFont(final FileHandle fontFile, final FileHandle imageFile, final boolean flip) {
        super(fontFile, imageFile, flip);
    }
    
    public DistanceFieldFont(final FileHandle fontFile, final TextureRegion region, final boolean flip) {
        super(fontFile, region, flip);
    }
    
    public DistanceFieldFont(final FileHandle fontFile, final TextureRegion region) {
        super(fontFile, region);
    }
    
    public DistanceFieldFont(final FileHandle fontFile) {
        super(fontFile);
    }
    ...
    protected void load(final BitmapFontData data) {
        super.load(data);
        final Array<TextureRegion> regions = this.getRegions();
    ...
    private static class DistanceFieldFontCache extends BitmapFontCache
    {
        ...
        private void setSmoothingUniform(final Batch spriteBatch, final float smoothing) {
            spriteBatch.flush();
