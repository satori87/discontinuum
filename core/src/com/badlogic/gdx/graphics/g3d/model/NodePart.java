...
public class NodePart
{
    ...
    protected NodePart set(final NodePart other) {
        ...
        if (other.invBoneBindTransforms == null) {
            ...
            if (this.invBoneBindTransforms == null) {
                this.invBoneBindTransforms = new ArrayMap<Node, Matrix4>(true, other.invBoneBindTransforms.size, Node.class, Matrix4.class);
            }
            else {
