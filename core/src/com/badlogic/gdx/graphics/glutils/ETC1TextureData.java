...
public class ETC1TextureData implements TextureData
{
    ...
    public ETC1TextureData(final FileHandle file) {
        this(file, false);
    }
    
    public ETC1TextureData(final FileHandle file, final boolean useMipMaps) {
        this.width = 0;
        this.height = 0;
    ...
    public ETC1TextureData(final ETC1.ETC1Data encodedImage, final boolean useMipMaps) {
        this.width = 0;
        this.height = 0;
        this.isPrepared = false;
    ...
    public void consumeCustomData(final int target) {
        ...
        if (!Gdx.graphics.supportsExtension("GL_OES_compressed_ETC1_RGB8_texture")) {
            final Pixmap pixmap = ETC1.decodeImage(this.data, Pixmap.Format.RGB565);
