...
public interface GL30 extends GL20
{
    ...
    void glDrawRangeElements(final int p0, final int p1, final int p2, final int p3, final int p4, final int p5);
    ...
    void glTexImage3D(final int p0, final int p1, final int p2, final int p3, final int p4, final int p5, final int p6, final int p7, final int p8, final int p9);
    ...
    void glTexSubImage3D(final int p0, final int p1, final int p2, final int p3, final int p4, final int p5, final int p6, final int p7, final int p8, final int p9, final int p10);
    ...
    Buffer glGetBufferPointerv(final int p0, final int p1);
    ...
    void glFlushMappedBufferRange(final int p0, final int p1, final int p2);
    ...
    void glBindBufferRange(final int p0, final int p1, final int p2, final int p3, final int p4);
    
    void glBindBufferBase(final int p0, final int p1, final int p2);
    
    void glTransformFeedbackVaryings(final int p0, final String[] p1, final int p2);
    
    void glVertexAttribIPointer(final int p0, final int p1, final int p2, final int p3, final int p4);
    ...
    void glCopyBufferSubData(final int p0, final int p1, final int p2, final int p3, final int p4);
    
    void glGetUniformIndices(final int p0, final String[] p1, final IntBuffer p2);
    ...
    void glGetActiveUniformBlockName(final int p0, final int p1, final Buffer p2, final Buffer p3);
    
    String glGetActiveUniformBlockName(final int p0, final int p1);
    ...
    void glDrawElementsInstanced(final int p0, final int p1, final int p2, final int p3, final int p4);
