...
public class SnapshotArray<T> extends Array<T>
{
    ...
    public SnapshotArray(final Array array) {
        super(array);
    }
    
    public SnapshotArray(final boolean ordered, final int capacity, final Class arrayType) {
        super(ordered, capacity, arrayType);
    }
    
    public SnapshotArray(final boolean ordered, final int capacity) {
        super(ordered, capacity);
    }
    
    public SnapshotArray(final boolean ordered, final T[] array, final int startIndex, final int count) {
        super(ordered, array, startIndex, count);
    }
    
    public SnapshotArray(final Class arrayType) {
        super(arrayType);
    }
    
    public SnapshotArray(final int capacity) {
        super(capacity);
    }
    
    public SnapshotArray(final T[] array) {
        super(array);
    }
