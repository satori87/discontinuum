...
public class IdentityMap<K, V> implements Iterable<Entry<K, V>>
{
    ...
    public IdentityMap(int initialCapacity, final float loadFactor) {
    ...
    public IdentityMap(final IdentityMap map) {
    ...
    public boolean equals(final Object obj) {
        ...
        final IdentityMap<K, V> other = (IdentityMap<K, V>)obj;
    ...
    public Iterator<Entry<K, V>> iterator() {
        return (Iterator<Entry<K, V>>)this.entries();
    }
    
    public Entries<K, V> entries() {
        if (this.entries1 == null) {
            this.entries1 = new Entries((IdentityMap<K, V>)this);
            this.entries2 = new Entries((IdentityMap<K, V>)this);
        }
    ...
    public Values<V> values() {
        if (this.values1 == null) {
            this.values1 = new Values((IdentityMap<?, V>)this);
            this.values2 = new Values((IdentityMap<?, V>)this);
        }
    ...
    public Keys<K> keys() {
        if (this.keys1 == null) {
            this.keys1 = new Keys((IdentityMap<K, ?>)this);
            this.keys2 = new Keys((IdentityMap<K, ?>)this);
        }
        if (!this.keys1.valid) {
            this.keys1.reset();
    ...
    public static class Values<V> extends MapIterator<Object, V, V>
    {
        ...
        public void toArray(final Array<V> array) {
            while (this.hasNext) {
                array.add(this.next());
            }
        }
