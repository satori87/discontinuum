...
public class Decoder
{
    ...
    class LenDecoder
    {
        ...
        public int Decode(final com.badlogic.gdx.utils.compression.rangecoder.Decoder rangeDecoder, final int posState) throws IOException {
    ...
    class LiteralDecoder
    {
        ...
        class Decoder2
        {
            ...
            public byte DecodeNormal(final com.badlogic.gdx.utils.compression.rangecoder.Decoder rangeDecoder) throws IOException {
                int symbol = 1;
                do {
            ...
            public byte DecodeWithMatchByte(final com.badlogic.gdx.utils.compression.rangecoder.Decoder rangeDecoder, byte matchByte) throws IOException {
                int symbol = 1;
                do {
