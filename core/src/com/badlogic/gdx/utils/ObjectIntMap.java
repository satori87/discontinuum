...
public class ObjectIntMap<K> implements Iterable<Entry<K>>
{
    ...
    public ObjectIntMap(final ObjectIntMap<? extends K> map) {
    ...
    public void putAll(final ObjectIntMap<? extends K> map) {
    ...
    public boolean equals(final Object obj) {
        ...
        final ObjectIntMap<K> other = (ObjectIntMap<K>)obj;
    ...
    public Entries<K> entries() {
        if (this.entries1 == null) {
            this.entries1 = new Entries((ObjectIntMap<K>)this);
            this.entries2 = new Entries((ObjectIntMap<K>)this);
        }
    ...
    public Keys<K> keys() {
        if (this.keys1 == null) {
            this.keys1 = new Keys((ObjectIntMap<K>)this);
            this.keys2 = new Keys((ObjectIntMap<K>)this);
        }
        if (!this.keys1.valid) {
            this.keys1.reset();
    ...
    public static class Entries<K> extends MapIterator<K> implements Iterable<Entry<K>>, Iterator<Entry<K>>
    {
        ...
        public Entries(final ObjectIntMap<K> map) {
            super(map);
    ...
    {
        public Keys(final ObjectIntMap<K> map) {
            super(map);
        }
    ...
    {
        public Values(final ObjectIntMap<?> map) {
            super(map);
        }
    ...
    private static class MapIterator<K>
    {
        ...
        public MapIterator(final ObjectIntMap<K> map) {
            this.valid = true;
            this.map = map;
            this.reset();
        }
        ...
        public void remove() {
            ...
            this.currentIndex = -1;
            final ObjectIntMap<K> map = this.map;
            --map.size;
        }
    }
}
