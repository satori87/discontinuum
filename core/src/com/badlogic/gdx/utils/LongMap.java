...
public class LongMap<V> implements Iterable<Entry<V>>
{
    ...
    public V put(final long key, final V value) {
        ...
        final int index1 = (int)(key & (long)this.mask);
        final long key2 = keyTable[index1];
        if (key2 == key) {
        ...
        final long key3 = keyTable[index2];
        if (key3 == key) {
        ...
        final long key4 = keyTable[index3];
        if (key4 == key) {
    ...
    public void putAll(final LongMap<? extends V> map) {
        for (final Entry<? extends V> entry : map.entries()) {
            this.put(entry.key, entry.value);
        }
    }
    
    private void putResize(final long key, final V value) {
        if (key == 0L) {
            this.zeroValue = value;
            this.hasZeroValue = true;
            return;
        ...
        final int index1 = (int)(key & (long)this.mask);
        final long key2 = this.keyTable[index1];
        if (key2 == 0L) {
        ...
        final int index2 = this.hash2(key);
        final long key3 = this.keyTable[index2];
        if (key3 == 0L) {
        ...
        final int index3 = this.hash3(key);
        final long key4 = this.keyTable[index3];
        if (key4 == 0L) {
    ...
    private void putStash(final long key, final V value) {
    ...
    public V get(final long key, final V defaultValue) {
        if (key != 0L) {
            int index = (int)(key & (long)this.mask);
            if (this.keyTable[index] != key) {
                index = this.hash2(key);
    ...
    private V getStash(final long key, final V defaultValue) {
        final long[] keyTable = this.keyTable;
        for (int i = this.capacity, n = i + this.stashSize; i < n; ++i) {
            if (keyTable[i] == key) {
    ...
    private boolean containsKeyStash(final long key) {
        final long[] keyTable = this.keyTable;
        for (int i = this.capacity, n = i + this.stashSize; i < n; ++i) {
            if (keyTable[i] == key) {
                return true;
    ...
    public long findKey(final Object value, final boolean identity, final long notFound) {
        final Object[] valueTable = this.valueTable;
        if (value == null) {
            if (this.hasZeroValue && this.zeroValue == null) {
                return 0L;
    ...
    private void resize(final int newSize) {
        ...
        final long[] oldKeyTable = this.keyTable;
    ...
    public boolean equals(final Object obj) {
        ...
        final LongMap<V> other = (LongMap<V>)obj;
    ...
    public Values<V> values() {
        if (this.values1 == null) {
            this.values1 = new Values((LongMap<V>)this);
            this.values2 = new Values((LongMap<V>)this);
        }
    ...
    public static class Entries<V> extends MapIterator<V> implements Iterable<Entry<V>>, Iterator<Entry<V>>
    {
        ...
        public Entries(final LongMap map) {
            super(map);
        ...
        public Entry<V> next() {
            ...
            final long[] keyTable = this.map.keyTable;
            if (this.nextIndex == -1) {
                this.entry.key = 0L;
    ...
    public static class Keys extends MapIterator
    {
        ...
        public long next() {
            ...
            final long key = (this.nextIndex == -1) ? 0L : this.map.keyTable[this.nextIndex];
            this.currentIndex = this.nextIndex;
            this.findNextIndex();
            return key;
        }
        ...
        public LongArray toArray() {
            final LongArray array = new LongArray(true, this.map.size);
            while (this.hasNext) {
                array.add(this.next());
            }
            return array;
    ...
    {
        public Values(final LongMap<V> map) {
            super(map);
        }
    ...
    private static class MapIterator<V>
    {
        ...
        public MapIterator(final LongMap<V> map) {
            this.valid = true;
            this.map = map;
            this.reset();
        }
