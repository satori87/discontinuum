...
public class Sprite extends TextureRegion {
	static final int VERTEX_SIZE = 2 + 1 + 2 + 1 + 1 + 2 + 2 + 2;
	...
	public Sprite () {
		setColor(1, 1, 1, 1);
		//System.out.println(SpriteBatch.particleX);
		//float sx = (1f/4096f) * SpriteBatch.particleX;
		//float sy = (1f/4096f) * SpriteBatch.particleY;
		//float sw = (1f/4096f)*32f;
		SpriteBatch b = (SpriteBatch)batch;
		setTexture(b.uTex[14]);
		setRegion((int)SpriteBatch.particleX,(int)SpriteBatch.particleY,32,32);
	}
